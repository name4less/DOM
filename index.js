...
DONE 4. Далее для каждого поста создаем див(контейнер). Внутри которого будут выводится данные о посте. Например:
Юзейр айди: { значение }
ай ди: { значение }
тайтл: { Значение }
боди: { значение }

DONE 5. Вешаем на каждый пост событие, по клику на которое в алерт выводится значение тайтла поста, по которому был клик.
